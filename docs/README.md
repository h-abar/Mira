...
- **ملف Excel (جذر المشروع):** [`باسوردات-النظام-Mira.xlsx`](../باسوردات-النظام-Mira.xlsx) — حسابات الدخول وقاعدة البيانات وإعدادات الخادم.
- **دليل Word (جذر المشروع):** `دليل-استخدام-نظام-ميرa-Mira.docx` (في جذر المشروع)
- **ملف Excel (docs):** [`docs/بيانات-الدخول.xlsx`](بيانات-الدخول.xlsx)
...
- [بيانات الدخول (Excel)](بيانات-الدخول.xlsx)
- [مرجع API](api.md)
